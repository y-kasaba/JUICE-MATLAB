...
function [st_ctl] = hf_ccsds_ql_bin(ql, st_ctl)
    ...
    if ~isfield(st_ctl, 'dir_out');    st_ctl.dir_out = '/Users/user/Documents/MATLAB/JUICE/data/'; end
    if strlength(st_ctl.dir_out) == 0; st_ctl.dir_out = '/Users/user/Documents/MATLAB/JUICE/data/'; end
    if ~isfield(st_ctl, 'dir_in');     st_ctl.dir_in  = '/Users/user/Documents/MATLAB/JUICE/data/'; end
    if strlength(st_ctl.dir_in) == 0;  st_ctl.dir_in  = '/Users/user/Documents/MATLAB/JUICE/data/'; end
