...
%------------------------------------------------------------------------------------------------
function [st_time, st_ctl] = hf_get_time_info_bin(st_ctl, st_sec, st_rpw)
    ...
    % 20240713
    st_time.cuc_time_pkg = st_sec.time; 
    st_time.cuc_time_obs = st_sec.time;
    % 
    ...
    julday = st_time.cuc_time_obs / 3600.0 / 24.0 + juliandate( datetime('2000-01-01 00:00:00') );
