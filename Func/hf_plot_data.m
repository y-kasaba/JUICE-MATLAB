...
function ret = hf_plot_data(st_ctl, st_rpw, st_aux, st_hfa, st_time, raw_data)
    ...
    switch st_rpw.sid
        ...
        case st_ctl.sid_raw
            ...
            st_ctl.label = ['SID-02 (Raw) : ' s ' - ' num2str(st_time.cuc_time_elapse,'%f')];
        ...
        case st_ctl.sid_full
            st_ctl.label = ['SID-03 (Full) : ' s ' - ' num2str(st_time.cuc_time_elapse,'%f')];
            fprintf('SID:%02x Radio full %s / %s\n', st_rpw.sid, st_time.obs_date, st_ctl.label);
        ...
        case st_ctl.sid_burst_s   % Radio burst, survey data
            ...
            st_ctl.label = ['SID-04 (Burst-S) : ' s ' - ' num2str(st_time.cuc_time_elapse,'%f')];
            [~, spec] = hf_proc_radio_full(st_ctl, st_aux, st_hfa, raw_data);
            if spec.matrix == 0
                ret = hf_plot_power(st_ctl, spec);
            else
        ...
        case st_ctl.sid_pssr1_s   % PSSR1, survey data
            ...
            st_ctl.label = ['SID-05 (PSSR1-S) : ' s ' - ' num2str(st_time.cuc_time_elapse,'%f')];
        ...
        case st_ctl.sid_pssr2_s   % PSSR2, survey data
            ...
            st_ctl.label = ['SID-06 (PSSR2-S) : ' s ' - ' num2str(st_time.cuc_time_elapse,'%f')];
        ...
        case st_ctl.sid_pssr3_s   % PSSR3, survey data
            ...
            if st_ctl.ver > 1
                st_ctl.label = ['SID-07 (PSSR3-S) : ' s ' - ' num2str(st_time.cuc_time_elapse,'%f')];
        ...
        case st_ctl.sid_burst_r   % Radio burst, rich data
            ...
            st_ctl.label = ['SID-20 (Burst-R) : ' s ' - ' num2str(st_time.cuc_time_elapse,'%f')];
        ...
        case st_ctl.sid_pssr1_r   % PSSR1, rich data
            ...
            st_ctl.label = ['SID-21 (PSSR1-R) : ' s ' - ' num2str(st_time.cuc_time_elapse,'%f')];
        ...
        case st_ctl.sid_pssr2_r   % PSSR2, rich data
            ...
            st_ctl.label = ['SID-22 (PSSR2-R) : ' s ' - ' num2str(st_time.cuc_time_elapse,'%f')];
...
%            ret = hf_plot_autocorr(st_rpw, st_ctl, auto);
        ...
        case st_ctl.sid_pssr3_r  % PSSR3, rich data
            ...
            if st_ctl.ver > 1
                st_ctl.label = ['SID-23 (PSSR3-R) : ' s ' - ' num2str(st_time.cuc_time_elapse,'%f')];
        ...
        case sid_pssr3_r_v1  % PSSR3, rich data V1
            ...
            if st_ctl.ver > 1
                st_ctl.label = ['SID-23 (PSSR3-R-V1) : ' s ' - ' num2str(st_time.cuc_time_elapse,'%f')];
                [~, wave, spec] = hf_proc_pssr3_rich(ver, st_aux, st_hfa, raw_data);
                ret = hf_plot_waveform_power(st_ctl, wave, spec);
                ret = hf_rpt_add_figure(st_ctl);
            else
